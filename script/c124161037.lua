...
function s.tg1filter(c)
	return c:IsSetCard(0xf22) and c:IsSpellTrap() and c:IsAbleToHand()
end
...
function s.op1(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e) and Duel.GetLocationCount(tp,LOCATION_MZONE)>0 and and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP) then
