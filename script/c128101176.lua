...
-- Card code references (You should define these globally or in constants)
CARD_OBSIDIM_ASHENED_CITY = 10000010 -- placeholder code
CARD_VEIDOS_ERUPTION_DRAGON = 10000020 -- placeholder code
...
function s.operation1(e,tp,eg,ep,ev,re,r,rp)
	...
	-- Send current field spell to GY
