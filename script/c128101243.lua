...
function s.initial_effect(c)
  ...
  e0:SetCode(EVENT_FREE_CHAIN)                    -- 패에서 자유롭게 발동
  e0:SetCountLimit(1,id+EFFECT_COUNT_CODE_OATH)   -- 동일명 1턴 1회 '발동' 제한
  e0:SetOperation(s.actop)                        -- 발동시 처리
  c:RegisterEffect(e0)
...
-- ① 발동시: 덱/묘지의 "홀로판타지" 필드마법 1장을 필드존에 '놓을 수 있다'
...
-- ② 1턴 1번: FZONE 1장 GY → 덱에서 "홀로판타지" 몬스터 1장 서치
