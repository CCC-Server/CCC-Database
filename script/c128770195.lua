...
-- 장착 대상 필터: 엘,모델의 적합자(128770189) or '엘'(0x758) 융합
...
function s.dacon(e)
	...
	-- '엘 모델의 적합자' 또는 '엘'(0x758) 융합 몬스터
	return tc:IsCode(128770189) or (tc:IsSetCard(0x758) and tc:IsType(TYPE_FUSION))
end
