...
function s.adop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	local val=e:GetHandler():GetBattleTarget():GetAttack()/2
...
function s.tg3filter(c)
	return c:IsSetCard(0xff0) and c:IsMonster() and c:IsAbleToHand()
end

function s.tg3(e,tp,eg,ep,ev,re,r,rp,chk)
	local g=Duel.GetMatchingGroup(s.tg3filter,tp,LOCATION_GRAVE,0,nil,e,tp)
