...
function s.chcon(e,tp,eg,ep,ev,re,r,rp)
	...
	return ch_player==1-tp and (ch_c:IsAttribute(ATTRIBUTE_DARK) and ch_c:IsControlerCanBeChanged() and ch_c:IsLocation(LOCATION_MZONE) and ch_c:IsControlerCanBeChanged() and ch_c:IsFaceup()) and not Duel.IsExistingTarget(HasFlagEffect,tp,LOCATION_MZONE,0,1,e:GetHandler(),id)
end
