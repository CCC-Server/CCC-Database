...
function s.condition(e,tp,eg,ep,ev,re,r,rp)
	...
	return re:GetActivateLocation()==LOCATION_HAND and re:GetHandler():IsLocation(LOCATION_HAND) and rp==1-tp and g==0
end
...
function s.target(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
	if chk==0 then return re:GetHandler():IsAbleToRemove() and Duel.GetLocationCount(tp,LOCATION_MZONE)>0 and c:IsCanBeSpecialSummoned(e,0,tp,false,false) end
...
function s.filter(c)
	return c:IsSetCard(0xda6) and not c:IsCode(id) and c:IsAbleToHand()
end
