...
function s.initial_effect(c)
	...
	--② 필드에 "스파클 아르카디아" 몬스터가 있을 경우 패에서 특수 소환
	...
	--③ 소환 성공 시 덱에서 "스파클 아르카디아" 마/함 1장 세트
...
----------------------------------------
--③: 덱에서 스파클 아르카디아 마법/함정 세트
----------------------------------------
function s.setfilter(c)
	return c:IsSetCard(0x760) and (c:IsType(TYPE_SPELL) or c:IsType(TYPE_TRAP)) and c:IsSSetable()
end
...
----------------------------------------
--④: 싱크로 소재 제한 ("스파클 아르카디아" 싱크로 몬스터만 가능)
----------------------------------------
