...
function s.initial_effect(c)
	-- 링크 소환 조건: "앰포리어스" 몬스터 포함한 몬스터 2장 이상
	c:EnableReviveLimit()
	Link.AddProcedure(c,aux.FilterBoolFunctionEx(Card.IsSetCard,0xc46),2,nil)

	--①: 링크 소환 성공 시, 지속 마법/함정 앞면으로 세트
...
function s.setfilter(c,tp)
	return c:IsSetCard(0xc46) and (c:IsContinuousSpell() or c:IsContinuousTrap())
