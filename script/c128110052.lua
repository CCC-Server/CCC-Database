...
function s.initial_effect(c)
	...
	e9:SetCode(EVENT_REMOVE_COUNTER+COUNTER_KAIJU)
	e9:SetProperty(EFFECT_FLAG_DELAY+EFFECT_FLAG_CARD_TARGET)
	e9:SetRange(LOCATION_MZONE)
	e9:SetCountLimit(1,id+1) -- 1턴에 1번
...
-- 옥시전 디스트로이어(128110035) 필터
function s.thfilter(c)
	return c:IsCode(128110035) and c:IsAbleToHand()
end
