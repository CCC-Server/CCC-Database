...
function s.initial_effect(c)
	...
	c:RegisterEffect(e1)
	--FIRE Dragon monsters you control are unaffected by your opponent's activated effects during your Battle
...
function s.atkfilter(c)
	return c:IsFaceup() and c:IsSetCard(0x81e) and c:IsType(TYPE_XYZ)
end
