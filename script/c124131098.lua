...
function s.initial_effect(c)
	c:EnableReviveLimit()
	Fusion.AddProcMix(c,true,true,s.pfil1,aux.FilterBoolFunctionEx(Card.IsRace,RACE_AQUA))
	--remove
...
function s.atkcond(e)
	return Duel.IsExistingMatchingCard(aux.FaceupFilter(Card.IsRace,RACE_AQUA),e:GetHandlerPlayer(),0,LOCATION_MZONE,1,nil)
end
