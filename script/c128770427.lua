local s,id=GetID()
local HUPYO_CODE=128770417 -- "수왕권사-후표"
...
function s.initial_effect(c)
	...
	-- Overlay Xyz Summon using "수왕권사-후표"
...
function s.ovfilter(c,tp)
	return c:IsFaceup() and c:IsCode(HUPYO_CODE)
...
function s.retop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=c:GetOverlayGroup():Filter(Card.IsCode,nil,HUPYO_CODE)
