...
function s.spfilter1(c,e,tp)
    return c:IsCode(100000655) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end

-- Filter for other "연금수" monsters
function s.spfilter2(c,e,tp)
    return c:IsSetCard(0x501) and c:IsCanBeSpecialSummoned(e,0,tp,false,false) and not c:IsCode(100000655)
end
