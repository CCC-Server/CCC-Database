...
function s.initial_effect(c)
	...
	-------------------------------------
	-- 몬스터 효과 ②: 소환 성공 시 마함 묘지로 + 효과 복사 (경우)
	-------------------------------------
...
-- E4: 소환 성공 시 요리 마함을 묘지로 보내고 그 효과 발동
function s.tgfilter2(c)
	return c:IsCode(14283055) and c:IsAbleToGrave() -- Concours de Cuisine
end
...
function s.mop2(e,tp,eg,ep,ev,re,r,rp)
	...
	local tc=g:GetFirst()
	if tc and Duel.SendtoGrave(tc,REASON_EFFECT)>0 and tc:GetActivateEffect() then
