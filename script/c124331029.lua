...
function s.spcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(s.spfilter,tp,LOCATION_ONFIELD,0,1,e:GetHandler())
end
...
function s.thfilter(c)
	return c:IsSetCard(0xda2) and c:IsAbleToHand() and not c:IsCode(id) and (c:IsLocation(LOCATION_DECK) or c:IsFaceup())
end
