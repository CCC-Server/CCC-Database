...
function s.cfilter(c,relzone,tp)
	return aux.IsZone(c,relzone,tp) and c:IsReleasable() and (c:IsSetCard(0xe00) or c:IsControler(1-tp))
end
...
function s.con1(e,tp,eg,ep,ev,re,r,rp)
	...
	return re:IsHasType(EFFECT_TYPE_ACTIVATE) and rc:IsSetCard(0xe00)
