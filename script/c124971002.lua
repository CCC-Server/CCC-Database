...
function s.initial_effect(c)
	...
	Duel.AddCustomActivityCounter(id,ACTIVITY_NORMALSUMMON,function(c) return c:IsSetCard(0xe00) end)
end
...
function s.tar2fil(c)
	return c:IsSetCard(0xe00) and c:IsSummonable(true,nil)
end
...
function s.tar3fil(c)	
	return c:IsMonster() and c:IsSetCard(0xe00) and (c:GetBaseAttack()>0 or c:GetBaseDefense()>0) and c:IsAbleToGraveAsCost()
end
