...
function s.tgcon(e,tp,eg,ep,ev,re,r,rp)
	...
	return e:GetHandler():IsLocation(LOCATION_REMOVED|LOCATION_GRAVE) and r & REASON_SYNCHRO == REASON_SYNCHRO
end
function s.tgfilter(c)
	return c:IsSetCard(0xc03) and c:IsType(TYPE_TUNER) and c:IsAbleToGrave()
end
...
return Duel.IsTurnPlayer(tp) and Duel.IsExistingMatchingCard(s.spfilter,tp,LOCATION_MZONE,0,1,nil)
end
