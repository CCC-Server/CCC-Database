...
function c128220063.initial_effect(c)
	...
	aux.AddUnionProcedure(c,aux.FilterBoolFunction(Card.IsSetCard,0xc23))
...
function s.thtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(s.tthfilter,tp,LOCATION_DECK,0,1,nil) end
