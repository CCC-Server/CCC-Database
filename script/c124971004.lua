...
function s.initial_effect(c)
	...
	e3:SetTarget(function(e,_c) return not _c:IsLocation(LOCATION_EXTRA) and not _c:IsSetCard(0xe00) end)
	c:RegisterEffect(e3)
...
function s.tar2fil(c)
	return c:IsSetCard(0xe00) and c:IsSpellTrap() and c:IsSSetable()
end
